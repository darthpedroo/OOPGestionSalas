...
class Reserva:
    def __init__(self, reservable: Reservable, usuario_reserva:"Usuario", fecha_reserva:Fecha, hora_inicio_reserva:Hora, hora_fin_reserva:Hora) -> None:
    ...
    def es_misma_hora_inicio(self, otra_hora_inicio: Hora):
        return self._hora_inicio_reserva == otra_hora_inicio
    
    def es_misma_hora_fin(self, otra_hora_fin: Hora):
